 ...
 */
package br.ifsul.sd.romulo.chat;
...
public class ChatClient {
    ...
    public ChatClient() {
        ...
        textField.addActionListener(new ActionListener() {
            /**
             * Responds to pressing the enter key by sending the contents of the
             * text field to the server, then clear it in preparation for the
             * next message.
             */
